import { Icon, useEscapeClose } from "@slock/ui";
...
export default function BrowseChannels() {
  ...
  return (
    <Show when={browsingChannels()}>
      {
        // biome-ignore lint/a11y/noStaticElementInteractions: backdrop click-to-close; Escape closes too
        ...
        >
          <div class="browse-channels-card">
            <div class="browse-channels-header">
              ...
              <button
                type="button"
                class="browse-channels-close"
                onClick={closeBrowseChannels}
                title="Close"
              >
                ✕
              </button>
                ...
                >
                  {(c) => (
                    <div class="browse-channels-row">
                      ...
                      <button
                        type="button"
                        class="browse-channels-join"
                        onClick={() => joinChannelById(c.id)}
                      >
                        Join
                      </button>
                    </div>
            ...
            <Show when={mode() === "create"}>
              <form class="browse-channels-create-form" onSubmit={submitCreate}>
                <label class="browse-channels-label" for="browse-channels-new-name">
                  Name
                </label>
                <input
                  id="browse-channels-new-name"
                  class="browse-channels-search"
                  type="text"
